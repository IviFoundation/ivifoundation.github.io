...
The Foundation publishes the software that implements these standards as free and open source and maintains it on a continuing basis; it also operates the conformance programme and the driver registry. It does not supply finished instruments or software products. Those are built by the instrument vendors and other integrators that incorporate the published components into their own products.
