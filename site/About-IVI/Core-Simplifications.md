...
The Configurable initial settings also facilitate instrument interchangeability by permitting a new instrument to receive certain configurations when the driver is instantiated so it can better mimic the instrument it is replacing.
