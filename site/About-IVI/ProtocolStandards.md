...
The IVI [protocol specifications](/About-IVI/ProtocolStandards.html) define aspects of the communication between the instruments and the test system. These standards are essential for  instruments from different manufacturers to expose interfaces that can be accessed by low-level system software. Thus allowing system software to control instruments regardless of the instrument vendor or the communication interface.
