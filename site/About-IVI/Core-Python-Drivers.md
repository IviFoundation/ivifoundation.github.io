...
-	The specification includes details of how the driver object is named.  Although this is normally of little concern, since IVI-Python is intended to be used by many vendors creating drivers for many different instruments, the details of how the instrument manufacturer, driver author, and the instrument model are incorporated into the name need to be standardized.
