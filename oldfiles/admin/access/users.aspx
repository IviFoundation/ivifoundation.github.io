...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
                            ...
                            <div id="usergrid">
                                <asp:GridView runat="server" ID="Users" AutoGenerateColumns="False" CssClass="userList"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="creationdate" HeaderText="Created" HtmlEncode="false" SortExpression="creationdate" DataFormatString="{0:MM/dd/yy hh:mm tt}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="lastlogindate" HeaderText="Last<br />Login" HtmlEncode="false" SortExpression="lastlogindate" DataFormatString="{0:MM/dd/yy hh:mm tt}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
    ...
    <asp:ObjectDataSource ID="odsUsers" runat="server" DeleteMethod="Delete" SortParameterName="SortData"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="Alphalinks" Name="nameFilterData" PropertyName="Filter"
                Type="String" />
            <asp:Parameter Name="roleFilterData" Type="String" />
            <asp:Parameter Name="onlyActive" Type="String" />
            <asp:Parameter Name="onlyOnline" Type="String" />
